...
export default function Dashboard() {
  ...
  const testAI = async () => {
    try {
      toast({ title: "Connecting to Gemini...", description: "Sending test prompt..." });
      const result = await generateContent("Hello, say 'Gemini is connected' if you can hear me.");
        ...
        <div className="space-y-6 max-w-4xl mx-auto">
          ...
          <Card className="border-dashed">
            <CardHeader>
              ...
              <CardDescription>Test the nudge system or AI connectivity</CardDescription>
            </CardHeader>
            <CardContent className="flex gap-2">
              <Button onClick={simulateStress} variant="outline">
                Simulate Stress
              </Button>
              <Button onClick={testAI} variant="secondary">
                Test AI
              </Button>
            </CardContent>
          </Card>
          ...
          {state.nudge.active && (
            <Card className="border-primary bg-primary/5 animate-in fade-in slide-in-from-top-2 duration-300">
              ...
              <CardContent>
                ...
                <Button className="w-full" onClick={handleStartExercise}>Start Breathing Exercise</Button>
              </CardContent>
            </Card>
          )}
